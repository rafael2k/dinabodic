...
{
    private final int defaultScreenWidth = Toolkit.getDefaultToolkit().getScreenSize().width;
    private final int defaultScreenHeight = Toolkit.getDefaultToolkit().getScreenSize().height;
